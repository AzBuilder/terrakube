...
public class SetupWorkspaceImpl implements SetupWorkspace {
    ...
    public SetupWorkspaceImpl(OkHttpClient httpClient, SetupPrivateRegistry setupPrivateRegistry, @Value("${org.terrakube.api.enableSecurity}") boolean enableRegistrySecurity) {
