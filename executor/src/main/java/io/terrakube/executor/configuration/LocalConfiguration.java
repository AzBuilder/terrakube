...
import io.terrakube.executor.plugin.tfstate.configuration.TerraformStateProperties;
import io.terrakube.executor.plugin.tfstate.configuration.TerraformStateType;
