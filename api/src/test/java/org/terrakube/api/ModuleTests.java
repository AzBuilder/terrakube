...
class ModuleTests extends ServerApplicationTests{
    ...
    @Test
    @Sql(statements = {
            "DELETE SCHEDULE; DELETE step; DELETE  history; DELETE job; DELETE variable; DELETE workspace; DELETE implementation; DELETE version; DELETE public.module; DELETE public.vcs; DELETE FROM provider; DELETE FROM team; DELETE FROM organization;",
