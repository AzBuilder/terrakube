...
public class Pending {
    ...
    public void pendingJobs() {
        ...
        for (Job job : restClient.getAllOrganizationsWithJobStatus("pending").getIncluded()) {
            ...
            String resourceUrl = "http://localhost:8090/api/v1/terraform-rs";
            ...
            ResponseEntity<TerraformJob> response = restTemplate.postForEntity(resourceUrl, terraformJob, TerraformJob.class);
